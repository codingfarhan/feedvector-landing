...
const faqs = [
  {
    ...
    answer:
      "FeedVector is better if you want a simpler AI-native publishing system with clear pricing, viral templates, AI media generation, MCP scheduling, team access, and Growth reporting options. Hootsuite is stronger if you need enterprise governance, listening, inbox operations, benchmarking, and deeper reporting.",
  },
  {
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/tab-image/plugs.png",
        width: 1200,
        height: 630,
        alt: "FeedVector automation preview",
      },
    ],
  },
  twitter: {
