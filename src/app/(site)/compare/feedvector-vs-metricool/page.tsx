...
const comparisonRows = [
  ...
  ["Team access", "2 additional users on Essential and unlimited users on Growth", "Team and client management starts on Advanced"],
]
...
const feedVectorFits = [
  ...
  "You want guided LinkedIn execution or done-for-you support",
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_270px]">
              <main className="space-y-16">
                <header className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="max-w-3xl text-base leading-7 text-gray-600 dark:text-gray-300 md:text-lg">
                      FeedVector and Metricool both help teams plan, publish, and analyze content. Metricool is a mature operations platform with
                      analytics, reports, inbox, ads, competitor tracking, and multi-brand workflows. FeedVector is an AI-first publishing system
                ...
                <section id="positioning" className="scroll-mt-28 space-y-5">
                  ...
                  <p className="text-base leading-7 text-gray-600 dark:text-gray-300">
                    FeedVector positions itself as a LinkedIn content tool with AI. Its workflow focuses on creating high-performing posts, using
                    viral templates, collaborating with a team, automating repeat work, and tracking analytics from one place.
                  </p>
                  <p className="text-base leading-7 text-gray-600 dark:text-gray-300">
                ...
                <section id="planning" className="scroll-mt-28 space-y-5">
                  ...
                  <p className="text-base leading-7 text-gray-600 dark:text-gray-300">
                    FeedVector supports planning ahead, queueing posts, and managing LinkedIn content from a single calendar. It is designed to keep
                    publishing consistent without forcing users into a large operations dashboard.
                  </p>
                  <p className="text-base leading-7 text-gray-600 dark:text-gray-300">
                ...
                <section id="analytics" className="scroll-mt-28 space-y-5">
                  ...
                  <p className="text-base leading-7 text-gray-600 dark:text-gray-300">
                    FeedVector offers analytics and insights on Pro. It is better suited to teams that want to understand what content is working and
                    improve the next week of publishing.
                  </p>
                  <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-white/10 dark:bg-white/5">
                    <p className="text-base font-semibold text-gray-800 dark:text-white/90">Verdict</p>
                    <p className="mt-2 text-base leading-7 text-gray-600 dark:text-gray-300">
                ...
                <section id="collaboration-pricing" className="scroll-mt-28 space-y-6">
                  ...
                  <p className="text-base leading-7 text-gray-600 dark:text-gray-300">
                    FeedVector includes teamwork, approvals, guided onboarding, and shared calendars. Essential supports 5 social media channels and 2
                  ...
                  <ImageShowcase
                    ...
                    description="Approvals, shared calendars, and guided onboarding help lean teams collaborate without a heavier operations setup."
                  />
